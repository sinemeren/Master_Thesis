...
from data_sets import ProcessParamDataSet, ProcessParamDataSetTEST, ProcessParamDataSetTEST_2, ProcessParamDataSetTEST_20_Analysis
...
class ProcessParamDataLoaderTEST_20_Analysis(BaseDataLoader):
    def __init__(self, data_dir, norm_range_min, norm_range_max, trainingDataSet, batch_size=None, shuffle=True,  validation_split=0.0, num_workers=1, training=True):
        ...
        self.dataset = ProcessParamDataSetTEST_20_Analysis(
